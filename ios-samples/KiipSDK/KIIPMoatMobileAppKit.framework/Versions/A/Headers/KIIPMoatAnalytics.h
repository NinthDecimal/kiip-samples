...
@interface KIIPMoatOptions : NSObject<NSCopying>
...
@interface KIIPMoatAnalytics : NSObject
 ...
 * @see KIIPMoatOptions
 */
- (void)startWithOptions:(KIIPMoatOptions *)options;
 ...
 * @see KIIPMoatVideoTracker.h for more detail on what constitues a native ad.
 *
