 ...
 */
@interface OMIDKiipmeAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(nonnull OMIDKiipmePartner *)partner
...
- (nullable instancetype)initWithPartner:(nonnull OMIDKiipmePartner *)partner
                               ...
                               resources:(nonnull NSArray<OMIDKiipmeVerificationScriptResource *> *)resources
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
