 ...
 */
@interface OMIDKiipmeVideoEvents : NSObject
 ...
 * @see OMIDAdSession
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDKiipmeAdSession *)session error:(NSError *_Nullable *_Nullable)error;
 ...
 */
- (void)loadedWithVastProperties:(nonnull OMIDKiipmeVASTProperties *)vastProperties;
