 ...
 *
 * @warning This class will be removed in a future version of this SDK. We recommend using KIIPMoatMPVideoTracker and KIIPMoatAVVideoTracker instead of this class.
...
@interface KIIPMoatVideoTracker : KIIPMoatBaseTracker
 ...
 * @return KIIPMoatVideoTracker instance
 */
+ (KIIPMoatVideoTracker *)trackerWithPartnerCode:(NSString *)partnerCode;
